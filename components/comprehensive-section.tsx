    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 mb-20">
          <h2 className="text-4xl font-bold text-center mb-12 text-white">Explore Social Media at Bell Bottom</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-6 shadow-xl">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Bell Bottom</h3>
                  <p className="text-sm text-gray-600">3,150 followers</p>
                </div>
              </div>

              <div className="flex gap-2 mb-4">
                <button className="bg-blue-600 text-white px-4 py-2 rounded text-sm font-medium flex items-center">
                  <span className="mr-2">👍</span> Follow Page
                </button>
                <button className="border border-gray-300 text-gray-700 px-4 py-2 rounded text-sm">Share</button>
              </div>
            ...
            <div className="flex justify-center items-center">
              <div className="bg-red-600 rounded-full p-8 border-4 border-amber-500">
                <div className="text-center">
                  <h3 className="text-3xl font-bold text-amber-400">BELL</h3>
                  <h3 className="text-xl font-bold text-white">BOTTOM</h3>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900">bellbottomeatery</h3>
                    <p className="text-sm text-gray-600">Bell Bottom Eatery</p>
                  </div>
                </div>
              ...
              <div className="text-center mb-4">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-2">1,180</p>
        ...
        <div className="container mx-auto px-4 mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
              ...
              <div className="relative">
                <div className="w-80 h-[600px] bg-black rounded-[3rem] p-4 shadow-2xl">
                  <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-orange-400 to-orange-600 p-6">
                      <div className="text-center text-white mb-6">
                        <h3 className="text-2xl font-bold">BELL</h3>
                        <h3 className="text-xl font-bold">BOTTOM</h3>
                        <button className="bg-red-600 text-white px-6 py-2 rounded-full mt-4 font-bold">
                          ORDER NOW
                        </button>
                      </div>

                      <div className="bg-white rounded-lg p-4 mb-4">
                        <h4 className="font-bold text-gray-800 mb-2">CURRY MEAL FOR ONE</h4>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="text-center">
                            <div className="w-16 h-16 bg-red-100 rounded-lg mb-1"></div>
                            <p className="text-xs">Chicken Tikka Masala</p>
                            <p className="text-sm font-bold">£8.95</p>
                          </div>
                          <div className="text-center">
                            <div className="w-16 h-16 bg-red-100 rounded-lg mb-1"></div>
                            <p className="text-xs">Butter Chicken</p>
                            <p className="text-sm font-bold">£8.95</p>
                          </div>
                        </div>
                      </div>
            ...
            <div className="text-white">
              ...
              <div className="bg-amber-500 text-black p-4 rounded-lg mb-8 flex items-center">
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4">Scan To Download Our App</h3>
        ...
        <div className="container mx-auto px-4 mb-20">
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">
            {/* Vegan Options */}
            <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg p-6 text-black">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <Link href="/menu/vegan" className="text-sm underline font-medium">
                    View Menu
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-lg p-6 text-white">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <Link href="/menu/vegetarian" className="text-sm underline font-medium">
                    View Menu
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <Link href="/menu/non-vegetarian" className="text-sm underline font-medium">
                    View Menu
                  </Link>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="text-white">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center">
                  <CheckCircle className="h-6 w-6 text-green-400 mr-3" />
                  <span className="text-lg">Best Service</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-6 w-6 text-green-400 mr-3" />
                  <span className="text-lg">Fresh Ingredient</span>
                </div>
              </div>
            </div>
          </div>
